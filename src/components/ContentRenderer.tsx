...
const ContentRenderer = ({ content }: { content: string }) => (
  <ReactMarkdown
    ...
    components={{
      h1: (props) => <DynamicTag as="h1" className="text-3xl" {...props} />,
      h2: (props) => <DynamicTag as="h1" className="text-2xl" {...props} />,
      h3: (props) => <DynamicTag as="h1" className="text-xl" {...props} />,
      p: (props) => <DynamicTag as="p" className="text-black" {...props} />,
      a: (props) => (
        <Link
      ...
      em: (props) => <DynamicTag as="em" className="italic" {...props} />,
      blockquote: (props) => (
        <DynamicTag
          as="blockquote"
      ...
      ul: (props) => (
        <DynamicTag
          as="ul"
          className="list-disc list-outside ml-8"
          {...props}
        />
      ),
      ol: (props) => (
